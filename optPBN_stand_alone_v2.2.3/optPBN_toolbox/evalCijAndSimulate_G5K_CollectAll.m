function [cijs,MeanStateValueAll,StdStateValueAll,MeanCostAll,StdCostAll] = evalCijAndSimulate_G5K_CollectAll(estim,bestRun,simFlag,Memory,x)
% [cijs,MeanStateValueAll,StdStateValueAll,MeanCostAll,StdCostAll] = evalCijAndSimulate_G5K_CollectAll(estim,bestRun,simFlag,Memory,x)
...
% Special script to study the variation of results within e.g., 10 iterations
